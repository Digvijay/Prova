...
namespace Prova.Generated
{
    ...
    public static class TestRunnerExecutor
    {
        ...
        public static global::System.Collections.Generic.IEnumerable<ProvaTest> GetTests()
        {
            ...
            // Class: MyDependencyTests
            list.Add(new ProvaTest
            {
                DisplayName = $""MyDependencyTests.DependencyTest"",
                Description = null,
                SkipReason = null,
                RetryCount = 0,
                MaxParallel = null,
                ...
                {
                    var instance = new MyDependencyTests(DependencyFactory.CreateService());
                    try {
                        long? maxAlloc = null;
                        long startAlloc = 0;
                        if (maxAlloc.HasValue) startAlloc = global::System.GC.GetAllocatedBytesForCurrentThread();
                        instance.DependencyTest();
