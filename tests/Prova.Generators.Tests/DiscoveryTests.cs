    ...
    public static class TestRunnerExecutor
    {
        ...
        public static global::System.Collections.Generic.IEnumerable<ProvaTest> GetTests()
        {
            ...
            list.Add(new ProvaTest
            {
                ...
                ExecuteDelegate = async () => 
                {
                    var instance = new MyTheoryTests();
                    try {
                        long? maxAlloc = null;
                        long startAlloc = 0;
                        if (maxAlloc.HasValue) startAlloc = global::System.GC.GetAllocatedBytesForCurrentThread();
...
namespace Prova.Generated
{
    ...
    public static class TestRunnerExecutor
    {
        ...
        public static global::System.Collections.Generic.IEnumerable<ProvaTest> GetTests()
        {
            ...
            list.Add(new ProvaTest
            {
                DisplayName = $""MySkipTests.SkippedTest"",
                Description = null,
                ...
                ExecuteDelegate = async () => 
                {
                    var instance = new MySkipTests();
                    try {
                        long? maxAlloc = null;
                        long startAlloc = 0;
                        if (maxAlloc.HasValue) startAlloc = global::System.GC.GetAllocatedBytesForCurrentThread();
                        instance.SkippedTest();
                        if (maxAlloc.HasValue)
                        {
                            long totalAlloc = global::System.GC.GetAllocatedBytesForCurrentThread() - startAlloc;
                            if (totalAlloc > maxAlloc.Value)
...
namespace Prova.Generated
{
    ...
    public static class TestRunnerExecutor
    {
        ...
        public static global::System.Collections.Generic.IEnumerable<ProvaTest> GetTests()
        {
            ...
            list.Add(new ProvaTest
            {
                DisplayName = $""MyFocusTests.FocusedTest"",
                Description = null,
                SkipReason = null,
                RetryCount = 0,
                MaxParallel = null,
                Traits = new[] { new global::System.Collections.Generic.KeyValuePair<string, string>(""Focus"", ""true"") },
                ExecuteDelegate = async () => 
                {
                    var instance = new MyFocusTests();
                    try {
                        long? maxAlloc = null;
                        long startAlloc = 0;
                        if (maxAlloc.HasValue) startAlloc = global::System.GC.GetAllocatedBytesForCurrentThread();
                        instance.FocusedTest();
                        if (maxAlloc.HasValue)
                        {
                            long totalAlloc = global::System.GC.GetAllocatedBytesForCurrentThread() - startAlloc;
                            if (totalAlloc > maxAlloc.Value)
...
namespace Prova.Generated
{
    ...
    public static class TestRunnerExecutor
    {
        ...
        public static global::System.Collections.Generic.IEnumerable<ProvaTest> GetTests()
        {
            ...
            list.Add(new ProvaTest
            {
                DisplayName = $""MyRetryTests.RetryTest"",
                Description = null,
                SkipReason = null,
                RetryCount = 3,
                MaxParallel = null,
