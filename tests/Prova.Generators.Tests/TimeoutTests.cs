...
namespace Prova.Generated
{
    ...
    public static class TestRunnerExecutor
    {
        ...
        public static global::System.Collections.Generic.IEnumerable<ProvaTest> GetTests()
        {
            ...
            // Class: MyTimeoutTests
            list.Add(new ProvaTest
            {
                DisplayName = $""MyTimeoutTests.SlowTest"",
                Description = null,
                SkipReason = null,
                RetryCount = 0,
                MaxParallel = null,
                ...
                {
                    var instance = new MyTimeoutTests();
                    try {
                        long? maxAlloc = null;
                        long startAlloc = 0;
                        if (maxAlloc.HasValue) startAlloc = global::System.GC.GetAllocatedBytesForCurrentThread();
                        var testTask = global::System.Threading.Tasks.Task.Run(async () => { await instance.SlowTest(); });
                        var timeoutTask = global::System.Threading.Tasks.Task.Delay(1000);
                        var completedTask = await global::System.Threading.Tasks.Task.WhenAny(testTask, timeoutTask);
                        if (completedTask == timeoutTask)
                            throw new global::System.TimeoutException(""Test exceeded timeout of 1000ms."");
